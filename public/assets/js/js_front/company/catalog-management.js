...
const renderSummary = () => {
  ...
  summaryElement.innerHTML = `
    ...
    Pagina: <b>${state.pagination.page} / ${state.pagination.total_pages}</b>
  `;

  if (pageLabelElement) {
    pageLabelElement.textContent = `Pagina ${state.pagination.page} de ${state.pagination.total_pages}`;
  }
